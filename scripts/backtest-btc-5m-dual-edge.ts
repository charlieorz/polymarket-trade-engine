...
import { __btc5mDualEdgeTestHooks } from "../engine/strategy/btc-5m-dual-edge.ts";
...
type B5dConfig = ReturnType<typeof __btc5mDualEdgeTestHooks.readBtc5mDualEdgeConfig>;
type B5dState = Parameters<typeof __btc5mDualEdgeTestHooks.chooseEntry>[0]["state"];
...
const LOG_DIR = process.env.B5D_BACKTEST_LOG_DIR ?? "logs";
const SPLIT_SEED = process.env.B5D_BACKTEST_SPLIT_SEED ?? "btc-5m-dual-edge-2026-05-19-random-exrun2-v1";
const SPLIT_MODE = process.env.B5D_BACKTEST_SPLIT_MODE ?? "random";
const EXCLUDE_RUN_LOG = process.env.B5D_BACKTEST_EXCLUDE_RUN_LOG ?? "logs/early-bird-2026-05-19-09-52-58.log";
const MIN_VALIDATION_TRADED_MARKETS = Math.max(
  1,
  Number(process.env.B5D_BACKTEST_MIN_VALIDATION_TRADED_MARKETS ?? 20),
);
const REPORT_DIR = process.env.B5D_BACKTEST_REPORT_DIR ?? "reports/backtests";
const EPSILON = 1e-9;
...
function simulateMarket(
  ...
  const stats = __btc5mDualEdgeTestHooks.createEdgeStats();
  ...
  for (const sample of market.samples) {
    __btc5mDualEdgeTestHooks.updateStats(stats, sample.price, sample.gap, sample.ts, config);
    ...
    if (!pendingEntry && !state.position) {
      const entry = __btc5mDualEdgeTestHooks.chooseEntry({
        ctx: mockCtx(sample),
        gap: sample.gap,
    ...
    const exit = __btc5mDualEdgeTestHooks.chooseExit({
      ctx: mockCtx(sample),
      pos: state.position,
      gap: sample.gap,
...
function configFromEnv(env: Record<string, string>): B5dConfig {
  return __btc5mDualEdgeTestHooks.readBtc5mDualEdgeConfig(env);
}

function buildVariants(): Variant[] {
  const baseEnv: Record<string, string> = {
    B5D_TICK_INTERVAL_MS: "200",
    B5D_STATS_INTERVAL_MS: "1000",
    B5D_SHARES: "6",
    B5D_ENTRY_START_SECONDS: "67",
    B5D_ENTRY_END_SECONDS: "217",
    B5D_MANAGED_EXIT_START_SECONDS: "200",
    B5D_HOLD_ONLY_START_SECONDS: "297",
    B5D_ENTRY_ORDER_TYPE: "GTC",
    B5D_TAKE_PROFIT_ORDER_TYPE: "GTC",
    B5D_STOP_LOSS_ORDER_TYPE: "FAK",
    B5D_ENTRY_TAKE_PROFIT_ENABLED: "false",
    B5D_MANAGED_TAKE_PROFIT_ENABLED: "true",
    B5D_STOP_LOSS_ENABLED: "true",
    B5D_SMALL_PROFIT_EXIT_MODE: "full_exit",
    B5D_HALF_STOP_HOLD_REST_TO_SETTLEMENT: "false",
    B5D_ENABLE_ADVANTAGE: "true",
    B5D_ENABLE_REVERSAL: "true",
    B5D_STOP_LOSS_START_SECONDS: "0",
    B5D_STOP_LOSS_MIN_HOLD_SECONDS: "0",
  };
  ...
  const entryProfiles: Array<{
  ...
  }> = [
    {
      ...
      env: {
        B5D_MAX_SPREAD: "0.07",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "3",
        B5D_MIN_EXIT_LIQUIDITY_USD: "3",
        B5D_ADV_MIN_ABS_GAP: "2",
        B5D_ADV_MIN_MOMENTUM: "0.08",
        B5D_ADV_MIN_CUMULATIVE_GAP: "5",
        B5D_MAX_ADVANTAGE_PRICE: "0.58",
        B5D_MAX_REVERSAL_PRICE: "0.52",
        B5D_REV_MAX_ABS_GAP: "8",
        B5D_REV_MIN_MOMENTUM: "0.08",
        B5D_REV_MIN_CUMULATIVE_GAP: "6",
      },
    },
    {
      name: "loose_adv_strict_reversal",
      profile: "aggressive",
      env: {
        B5D_MAX_SPREAD: "0.08",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "2.5",
        B5D_MIN_EXIT_LIQUIDITY_USD: "2.5",
        B5D_ADV_MIN_ABS_GAP: "1.5",
        B5D_ADV_MIN_MOMENTUM: "0.05",
        B5D_ADV_MIN_CUMULATIVE_GAP: "2",
        B5D_MAX_ADVANTAGE_PRICE: "0.6",
        B5D_MAX_REVERSAL_PRICE: "0.44",
        B5D_REV_MAX_ABS_GAP: "5",
        B5D_REV_MIN_MOMENTUM: "0.12",
        B5D_REV_MIN_CUMULATIVE_GAP: "18",
      },
    },
    {
      name: "loose_adv_discount_reversal",
      profile: "aggressive",
      env: {
        B5D_MAX_SPREAD: "0.08",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "2.5",
        ...
        B5D_ADV_MIN_CUMULATIVE_GAP: "2",
        B5D_MAX_ADVANTAGE_PRICE: "0.6",
        B5D_MAX_REVERSAL_PRICE: "0.47",
        B5D_REV_MAX_ABS_GAP: "6.5",
        B5D_REV_MIN_MOMENTUM: "0.1",
        B5D_REV_MIN_CUMULATIVE_GAP: "12",
      },
    },
    {
      name: "wide_adv_strict_reversal",
      profile: "conservative",
      env: {
        B5D_MAX_SPREAD: "0.07",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "3",
        ...
        B5D_MAX_REVERSAL_PRICE: "0.44",
        B5D_REV_MAX_ABS_GAP: "5",
        B5D_REV_MIN_MOMENTUM: "0.14",
        B5D_REV_MIN_CUMULATIVE_GAP: "20",
      },
    },
    {
      name: "wide_adv_only",
    ...
    },
    {
      ...
      profile: "conservative",
      env: {
        B5D_ENABLE_ADVANTAGE: "false",
        B5D_MAX_SPREAD: "0.07",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "3",
        B5D_MIN_EXIT_LIQUIDITY_USD: "3",
        B5D_ADV_MIN_ABS_GAP: "999",
        B5D_ADV_MIN_MOMENTUM: "999",
        B5D_ADV_MIN_CUMULATIVE_GAP: "999",
        B5D_MAX_ADVANTAGE_PRICE: "0.45",
        B5D_MAX_REVERSAL_PRICE: "0.47",
        B5D_REV_MAX_ABS_GAP: "8",
        B5D_REV_MIN_MOMENTUM: "0.08",
        B5D_REV_MIN_CUMULATIVE_GAP: "6",
    ...
    },
    {
      ...
      env: {
        ...
        B5D_ADV_MIN_CUMULATIVE_GAP: "999",
        B5D_MAX_ADVANTAGE_PRICE: "0.45",
        B5D_MAX_REVERSAL_PRICE: "0.42",
        B5D_REV_MAX_ABS_GAP: "9",
        B5D_REV_MIN_MOMENTUM: "0.06",
        B5D_REV_MIN_CUMULATIVE_GAP: "10",
      },
    },
    {
    ...
    },
    {
      ...
      env: {
        ...
        B5D_ADV_MIN_MOMENTUM: "0.05",
        B5D_ADV_MIN_CUMULATIVE_GAP: "2",
        B5D_MAX_ADVANTAGE_PRICE: "0.5",
        B5D_MAX_REVERSAL_PRICE: "0.5",
        B5D_REV_MAX_ABS_GAP: "9",
        B5D_REV_MIN_MOMENTUM: "0.05",
        B5D_REV_MIN_CUMULATIVE_GAP: "8",
      },
    },
    {
      name: "deep_adv_only",
    ...
    },
    {
      ...
      env: {
        B5D_MAX_SPREAD: "0.06",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "4",
        B5D_MIN_EXIT_LIQUIDITY_USD: "4",
        B5D_ADV_MIN_ABS_GAP: "3",
        B5D_ADV_MIN_MOMENTUM: "0.12",
        B5D_ADV_MIN_CUMULATIVE_GAP: "10",
        B5D_MAX_ADVANTAGE_PRICE: "0.56",
        B5D_MAX_REVERSAL_PRICE: "0.5",
        B5D_REV_MAX_ABS_GAP: "6.5",
        B5D_REV_MIN_MOMENTUM: "0.12",
        B5D_REV_MIN_CUMULATIVE_GAP: "14",
      },
    },
    {
      name: "loose_adv_only",
    ...
    },
    {
      ...
      env: {
        B5D_MAX_SPREAD: "0.05",
        B5D_MIN_ENTRY_LIQUIDITY_USD: "6",
        B5D_MIN_EXIT_LIQUIDITY_USD: "6",
        B5D_ADV_MIN_ABS_GAP: "4.5",
        B5D_ADV_MIN_MOMENTUM: "0.26",
        B5D_ADV_MIN_CUMULATIVE_GAP: "45",
        B5D_MAX_ADVANTAGE_PRICE: "0.5",
        B5D_MAX_REVERSAL_PRICE: "0.5",
        B5D_REV_MAX_ABS_GAP: "4.5",
        B5D_REV_MIN_MOMENTUM: "0.26",
        B5D_REV_MIN_CUMULATIVE_GAP: "45",
      },
    },
  ];
  ...
  const exitProfiles: Array<{ name: string; env: Record<string, string> }> = [
    {
      ...
      env: {
        B5D_MANAGED_EXIT_START_SECONDS: "170",
        B5D_STOP_LOSS_START_SECONDS: "120",
        B5D_STOP_LOSS_MIN_HOLD_SECONDS: "30",
        B5D_HALF_STOP_LOSS_RATIO: "0.35",
        B5D_FULL_STOP_LOSS_RATIO: "0.35",
        B5D_FULL_TAKE_PROFIT_RATIO: "0.22",
        B5D_TAKE_PROFIT_PRICE_IMMEDIATE: "0.78",
      },
    },
    {
      name: "no_half_delay45_stop45",
      env: {
        B5D_MANAGED_EXIT_START_SECONDS: "190",
        B5D_STOP_LOSS_START_SECONDS: "150",
        B5D_STOP_LOSS_MIN_HOLD_SECONDS: "45",
        B5D_HALF_STOP_LOSS_RATIO: "0.45",
        B5D_FULL_STOP_LOSS_RATIO: "0.45",
        B5D_FULL_TAKE_PROFIT_RATIO: "0.28",
        B5D_TAKE_PROFIT_PRICE_IMMEDIATE: "0.82",
      },
    },
    {
      ...
      env: {
        ...
        B5D_STOP_LOSS_START_SECONDS: "150",
        B5D_STOP_LOSS_MIN_HOLD_SECONDS: "45",
        B5D_HALF_STOP_LOSS_RATIO: "0.3",
        B5D_FULL_STOP_LOSS_RATIO: "0.5",
        B5D_FULL_TAKE_PROFIT_RATIO: "0.28",
        B5D_TAKE_PROFIT_PRICE_IMMEDIATE: "0.82",
      },
    },
    ...
    },
    {
      ...
      env: {
        ...
        B5D_HALF_STOP_LOSS_RATIO: "0.3",
        B5D_FULL_STOP_LOSS_RATIO: "0.45",
        B5D_FULL_TAKE_PROFIT_RATIO: "0.45",
        B5D_TAKE_PROFIT_PRICE_IMMEDIATE: "0.87",
      },
    },
  ];

  const shareProfiles = [{ name: "shares6", env: { B5D_SHARES: "6" } }];

  const executionProfiles = [
    { name: "passive", env: { B5D_ENTRY_ORDER_TYPE: "GTC", B5D_ENTRY_ORDER_TTL_MS: "2500" } },
    { name: "marketable", env: { B5D_ENTRY_ORDER_TYPE: "FAK", B5D_ENTRY_ORDER_TTL_MS: "750" } },
  ];
...
function isDefaultEligible(variant: Variant): boolean {
  return (
    variant.config.enableAdvantage &&
    variant.config.enableReversal &&
    variant.config.shares === 6 &&
    variant.train!.pnl > 0 &&
...
async function main() {
  ...
  const reportBase = join(REPORT_DIR, `btc-5m-dual-edge-${SPLIT_SEED}`);
